...
def main(): 
    ...
    for variation in variations:
        try:
            with open(f"results/{model_name}/results_{variation}.json", "r") as f:
    ...
    for prompt_index in tqdm(selected_prompts, desc="Processing prompts"):
        ...
        for variation in variations:
            ...
            percent_correct, responses = run_variation_test(
                ...
                prompts, 
                variation, 
                model_name #change model name here
            )
            ...
            with open(f"results/{model_name}/results_{variation}.json", "w") as f:
