...
def gemini_query(prompt: str, image_path: str, model_name: str) -> str:
...
def main(): 
    ...
    for variation in variations:
        try:
            with open(f"results/{MODEL}/results_{variation}.json", "r") as f:
    ...
    for prompt_index in tqdm(selected_prompts, desc="Processing prompts"):
        ...
        for variation in variations:
            ...
            with open(f"results/{MODEL}/results_{variation}.json", "w") as f:
